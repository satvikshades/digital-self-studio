...
export default function WebcamCapture({ onCapture, isProcessing }: WebcamCaptureProps) {
  ...
  const capturePhoto = () => {
    ...
    ctx.drawImage(video, offsetX, offsetY, size, size, 0, 0, 768, 768);
    ...
    <div className="animate-fade-in">
      <div className="relative clean-card overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
          <div className="w-44 h-56 md:w-52 md:h-68 rounded-[50%] border-2 border-dashed border-primary/40" />
        </div>
        ...
        {isCapturing && <div className="absolute inset-0 bg-white/50 z-30" />}
